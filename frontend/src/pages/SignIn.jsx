...
try {
 ...
 setUserData(result.data)
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}} onError={(e) => {
      e.target.style.backgroundImage = 'linear-gradient(to bottom, #000000, #1a1a2e)';
    }}>
