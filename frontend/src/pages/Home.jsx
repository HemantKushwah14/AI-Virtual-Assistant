...
function Home() {
  const {userData,serverUrl,setUserData,getGeminiResponse,logout}=useContext(userDataContext)
...
}, [getGeminiResponse, handleCommand, userData.assistantName, userData.name]);
